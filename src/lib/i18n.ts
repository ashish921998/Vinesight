  ...
  en: {
    translation: {
      ...
      home: {
        ...
        description: "Digitize farming operations with scientific calculations, record-keeping, and analytics",
        features: {
          farmManagement: {
        ...
        gettingStarted: {
          ...
          description: "Begin by adding your farm details and start using our scientific calculators",
          button: "Add Your First Farm"
        },
        joinToday: {
          title: "Join VineSight Today",
          description: "Sign in with Google to start managing your vineyard operations scientifically",
  ...
  hi: {
    translation: {
      ...
      home: {
        ...
        description: "वैज्ञानिक गणना, रिकॉर्ड-कीपिंग और एनालिटिक्स के साथ खेती संचालन डिजिटाइज़ करें",
        features: {
          farmManagement: {
            title: "फार्म प्रबंधन",
        ...
        gettingStarted: {
          title: "शुरुआत करें",
          description: "अपने फार्म विवरण जोड़कर शुरुआत करें और हमारे वैज्ञानिक कैलकुलेटर का उपयोग करें",
          button: "अपना पहला फार्म जोड़ें"
        },
        joinToday: {
          title: "आज ही वाइनसाइट में शामिल हों",
          description: "अपने अंगूर बाग संचालन को वैज्ञानिक रूप से प्रबंधित करने के लिए Google के साथ साइन इन करें",
      ...
      export: {
        ...
        description: "अपने फार्म डेटा को CSV फाइलों के रूप में निर्यात करें या पेशेवर PDF रिपोर्ट जेनरेट करें",
  ...
  mr: {
    translation: {
      ...
      home: {
        ...
        description: "वैज्ञानिक गणना, रेकॉर्ड-कीपिंग आणि एनालिटिक्सच्या सहाय्याने शेती संचालन डिजिटाइज करा",
        features: {
          farmManagement: {
        ...
        joinToday: {
          ...
          description: "तुमच्या द्राक्षबाग संचालनाचे वैज्ञानिक व्यवस्थापन करण्यासाठी Google सह साइन इन करा",
      ...
      farm: {
        ...
        grapeVariety: "द्राक्षाचा प्रकार",
      ...
      export: {
        ...
        description: "तुमचा शेत डेटा CSV फाइल्स म्हणून निर्यात करा किंवा व्यावसायिक PDF अहवाल तयार करा",
