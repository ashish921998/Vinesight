...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Transform your farming operations with AI-driven crop monitoring, yield prediction, and automated farm management. Perfect for grape farming and precision agriculture.',
    siteName: 'FarmAI',
    images: [
      {
        url: '/og-image.png',
  ...
  twitter: {
    ...
    description: 'Transform farming with AI-driven crop monitoring, yield prediction, and automated management systems.',
    images: ['/og-image.png'],
    creator: '@FarmAI',
  },
  icons: {
