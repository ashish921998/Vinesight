...
const featuredPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Learn how to use evapotranspiration data to optimize your irrigation schedule and reduce water waste by up to 30%.',
  ...
  },
  {
    ...
    excerpt: 'Discover the science behind our AI-powered pest prediction system and how it helps farmers prevent crop damage.',
    content: 'Full article content...',
    author: 'Priya Sharma',
  ...
  },
  {
    ...
    excerpt: 'Essential steps to protect your vineyard during monsoon season, from drainage to disease prevention.',
    content: 'Full article content...',
    author: 'Amit Patil',
...
const recentPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: 'Analysis of current market conditions and emerging export opportunities for Indian grape farmers.',
    content: 'Full article content...',
    author: 'Kavita Joshi',
  ...
  },
  {
    ...
    excerpt: 'Natural and sustainable approaches to managing common grape pests without harmful chemicals.',
    content: 'Full article content...',
    author: 'Ravi Kumar',
  ...
  },
  {
    ...
    excerpt: 'Step-by-step guide to implementing automated irrigation using soil moisture sensors and weather data.',
    content: 'Full article content...',
    author: 'Arjun Reddy',
  ...
  },
  {
    ...
    excerpt: 'Professional pruning methods to improve grape quality, increase yield, and maintain vine health.',
    content: 'Full article content...',
  ...
  },
  {
    ...
    excerpt: 'Strategies to adapt your farming practices to changing climate conditions and extreme weather.',
    content: 'Full article content...',
        ...
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
          ...
          <div className="bg-white border-b border-gray-200">
            <div className="max-w-4xl mx-auto px-4 py-6">
              ...
              <div className="mb-8">
                <Badge className={`${blogCategories.find(c => c.id === post.category)?.color} mb-4`}>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="text-center py-16 border border-gray-200 rounded-lg bg-gray-50">
                  <h3 className="text-xl font-semibold text-gray-600 mb-2">Full Article Coming Soon</h3>
                  <p className="text-gray-500">
                    We're working on detailed articles for our blog. Stay tuned for comprehensive content!
                  </p>
                </div>
              </div>
            </div>
          ...
          {selectedCategory && (
            <div className="flex items-center gap-2 mb-4">
              <Badge variant="secondary">
                Showing {filteredPosts.length} articles in "{blogCategories.find(c => c.id === selectedCategory)?.name}"
              </Badge>
                  ...
                  <div className="relative h-48 lg:h-60 bg-gradient-to-br from-green-100 to-blue-100 rounded-t-lg">
                    <div className="absolute inset-0 flex items-center justify-center">
                      {blogCategories.find(c => c.id === post.category)?.icon && 
                        React.createElement(blogCategories.find(c => c.id === post.category)!.icon, {
                          className: "h-16 w-16 text-green-600 opacity-50"
                        })
                      }
                    </div>
                    <Badge className={`absolute top-4 left-4 ${blogCategories.find(c => c.id === post.category)?.color}`}>
                      {blogCategories.find(c => c.id === post.category)?.name}
                    </Badge>
                  </div>
