              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                    AI-Powered<br />
                    <span className="text-green-600">Farm Management</span><br />
                    Made Simple
                  </h1>
                  <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                    Transform your farming operations with advanced AI insights, real-time monitoring, and data-driven decision making tools.
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 leading-relaxed">Monitor your farm's performance with comprehensive dashboards and real-time data visualization.</p>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 leading-relaxed">Advanced crop monitoring and management tools powered by AI and IoT sensors.</p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 leading-relaxed">Get personalized farming recommendations based on your farm's data and external factors.</p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="p-8 space-y-6 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600">Comprehensive analytics and reporting tools to track farm performance, yields, and profitability.</p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              ...
              <Card className="p-8 space-y-6 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600">Get personalized farming recommendations and insights powered by artificial intelligence.</p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              ...
              <Card className="p-8 space-y-6 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600">Real-time weather data and forecasts to optimize farming decisions and scheduling.</p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              ...
              <Card className="p-8 space-y-6 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600">Monitor farm efficiency, track KPIs, and identify areas for improvement.</p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              ...
              <Card className="p-8 space-y-6 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600">Organize farm tasks, set reminders, and coordinate team activities efficiently.</p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              ...
              <Card className="p-8 space-y-6 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-600">Early warning system for pest and disease outbreaks using AI and weather data.</p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600 flex-shrink-0" />
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed">
                    VineSight combines cutting-edge artificial intelligence with deep agricultural expertise to help farmers optimize their operations, increase yields, and maximize profitability.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600 text-sm">Advanced machine learning algorithms analyze your farm data to provide actionable recommendations.</p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600 text-sm">Make informed decisions based on real-time data, weather patterns, and predictive analytics.</p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600 text-sm">Early warning systems for pests, diseases, and weather events help protect your crops.</p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600 text-sm">Track performance metrics and identify opportunities for optimization and growth.</p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center">
              <div className="text-sm text-gray-400">
                © 2025 VineSight. All rights reserved.
              </div>
