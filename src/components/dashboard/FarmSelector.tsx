          ...
          {!selectedFarmId ? (
            ...
            <>
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className={`text-sm font-semibold ${getHealthScoreColor(selectedFarm.healthScore)}`}>
          ...
          <CardContent className="p-2">
            <div className="space-y-1">
              ...
              {farms.map((farm) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`w-3 h-3 rounded-full flex-shrink-0 ${getStatusColor(farm.status)}`} />
                    <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <div className="text-center">
                        <div className={`text-sm font-semibold ${getHealthScoreColor(farm.healthScore)}`}>
                          {farm.healthScore}
                        </div>
...
export function FarmTabs({ 
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'healthy': return 'border-green-200 bg-green-50 text-green-800';
      case 'attention': return 'border-amber-200 bg-amber-50 text-amber-800';
