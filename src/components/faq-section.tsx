...
export default function FAQSection() {
  ...
  return (
    <div className="w-full flex justify-center items-start bg-background">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full px-5 py-[18px] flex justify-between items-center gap-5 text-left hover:bg-accent transition-colors duration-200"
