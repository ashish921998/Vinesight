      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Distribution of operational costs by category</CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <div key={revenue.source} className="space-y-2">
                      ...
                      {revenue.quantity && revenue.unitPrice && (
                        <div className="text-xs text-muted-foreground pl-5">
                          {revenue.quantity.toLocaleString()} units ×{' '}
                          {formatCurrency(revenue.unitPrice)} each
                        </div>
                      )}
                    </div>
                  )
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Revenue covers {totalCosts > 0 ? (totalRevenue / totalCosts).toFixed(1) : '0'}x the
                costs
              </p>
            </div>
