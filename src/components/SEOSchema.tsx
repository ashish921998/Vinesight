    ...
    "@graph": [
      {
        ...
        "sameAs": [
          "https://twitter.com/FarmAI",
          "https://linkedin.com/company/farmai"
        ],
        "description": "AI-powered smart farm management system for precision agriculture and intelligent crop monitoring"
      },
      {
        "@type": "WebSite",
