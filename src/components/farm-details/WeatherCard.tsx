      ...
      <CardContent className="pt-0 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            ...
            <span className="font-semibold text-gray-800">{weatherData.windSpeed10m.toFixed(1)} m/s</span>
          </div>

          <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
            <div className="flex items-center gap-2">
              <CloudRain className="h-4 w-4 text-blue-600" />
              <span className="text-sm font-medium text-blue-700">Rainfall</span>
            </div>
            <span className="font-semibold text-blue-800">{weatherData.precipitationSum.toFixed(1)} mm</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="p-3 bg-yellow-50 border border-yellow-100 rounded-lg">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-yellow-700">Today's Solar Radiation</span>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                <div className="flex justify-between text-sm">
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-yellow-600">lux (daylight avg)</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-orange-700">Sunshine Duration</span>
            </div>
            <span className="font-semibold text-orange-800">{weatherData.sunshineDuration.toFixed(1)} hrs</span>
          </div>
        </div>
        ...
        <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-green-700">Reference Evapotranspiration (ETo)</span>
            </div>
            <div className="text-right">
