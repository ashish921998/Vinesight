                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {farm.area}ha • {farm.vineSpacing}×{farm.rowSpacing}m
                      </p>
                    </div>
                    {selectedFarm?.id === farm.id && (
          ...
          <div className="mx-4 sm:mx-0 space-y-4 sm:space-y-3">
            ...
            <Card>
              <CardHeader
                ...
                onClick={() =>
                  setActiveSection(activeSection === 'measurement' ? 'measurement' : 'measurement')
                }
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:gap-3">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: 'wine' | 'table' | 'raisin') =>
                          handleInputChange('productionGoal', value)
                        }
                      >
                        <SelectTrigger className="h-12 sm:h-11 text-base sm:text-sm">
                          <SelectValue />
              ...
              <Card className="border-green-200 bg-green-50">
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      variant={
                        results.canopyDensity === 'optimal'
                          ? 'default'
                          : results.canopyDensity === 'dense'
                            ? 'secondary'
                            : 'destructive'
                      }
                ...
                <CardContent className="pt-0 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-white rounded-lg p-3 text-center border border-green-200">
                      <div className="text-2xl font-bold text-green-700">
                        {results.leafAreaPerVine.toFixed(1)}
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white rounded-lg p-3 text-center border border-green-200">
                      <div className="text-2xl font-bold text-green-700">
                        {results.lightInterception.toFixed(1)}%
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="bg-green-50 rounded-lg p-3 border border-green-200">
                          ...
                          <p className="text-sm text-green-700">
                            Canopy density is {results.canopyDensity}
                          </p>
                        </div>

                        {results.recommendations.canopyManagement &&
                    ...
                    <div className="bg-white rounded-lg p-3 border border-green-200">
                      ...
                      {results.lai < optimalTargets.minLAI && (
                        <p className="text-xs text-red-600">
                          Increase canopy density for better yield potential
                        </p>
                      )}
                      {results.lai > optimalTargets.maxLAI && (
                        <p className="text-xs text-red-600">
                          Reduce canopy density to prevent disease and improve quality
                        </p>
                      )}
                    </div>
                  </div>
