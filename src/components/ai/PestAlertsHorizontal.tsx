    ...
    <div className={className}>
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide snap-x snap-mandatory" 
        ...
        {topAlerts.map((prediction) => {
          ...
          const isUrgent = prediction.riskLevel === 'critical' || (prediction.riskLevel === 'high' && daysUntilOnset <= 3);
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-600">
                      ...
                      <Badge 
                        variant={prediction.riskLevel === 'critical' ? 'destructive' : 
              ...
              <CardContent className="px-3 pb-3 pt-0">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className={`font-medium ${
                      daysUntilOnset <= 2 ? 'text-red-600' :
                      daysUntilOnset <= 5 ? 'text-orange-600' : 'text-gray-600'
                    }`}>
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded px-2 py-1">
                      <div className="flex items-center gap-1 text-amber-800">
                        ...
                        <span className="text-xs font-medium">
                          {prediction.communityReports} nearby report{prediction.communityReports !== 1 ? 's' : ''}
                        </span>
                      </div>
                    </div>
                  )}
